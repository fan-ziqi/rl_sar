...
public:
    ...
    std::shared_ptr<FSMState> createState(void *context, const std::string &stateName) override
    {
        ...
        if (stateName == "RLFSMStateWaiting")
            ...
            return std::make_shared<l4w4_fsm::RLFSMStateRL_Navigation>(rl);
        return nullptr;
    }
...
REGISTER_FSM_FACTORY(L4w4FSMFactory, "RLFSMStateWaiting")
